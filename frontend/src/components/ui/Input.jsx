  ...
  return (
    <label className="block">
      ...
      <Component
        ...
        className={`mt-2 w-full rounded-2xl border bg-white px-4 text-sm font-medium text-[#1E293B] outline-none transition duration-200 placeholder:text-slate-400 focus:ring-4 ${
          error
